...
public class SaveData : ResettableScriptableObject
{
    ...
    public void Assign(SaveData saveData)
    {
        boolKeyValuePairLists = saveData.boolKeyValuePairLists;
        intKeyValuePairLists = saveData.intKeyValuePairLists;
        stringKeyValuePairLists = saveData.stringKeyValuePairLists;
        vector3KeyValuePairLists = saveData.vector3KeyValuePairLists;
        quaternionKeyValuePairLists = saveData.quaternionKeyValuePairLists;
    }
